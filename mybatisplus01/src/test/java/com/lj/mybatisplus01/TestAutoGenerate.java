...
public class TestAutoGenerate {
    ...
    public void autoGenerate() {
        ...
        // 配置数据库 url 地址
        dsc.setUrl("jdbc:mysql://localhost:3306/mybatis_plus?useUnicode=true&characterEncoding=utf8&serverTimezone=GMT");
        ...
        pc.setParent("com.lj");
        // 配置模块名（需要修改）
        pc.setModuleName("mybatisplus01");
        // 配置 entity 包名
        pc.setEntity("entity");
        // 配置 mapper 包名
        pc.setMapper("mapper");
